...
export const TESTIMONIALS = [
  {
    quote:
      "Splitzy saved our group from constant confusion over payments. Accurate splits, instant updates, and zero stress.",
    name: "Harshit Singh",
  ...
  {
    quote:
      "I love how simple and intuitive Splitzy is. Whether it’s trips, rent, or daily expenses, it keeps everyone on the same page.",
    image: "/testimonials/t3.jpg",
    role: "MBA student",
  },
  {
    quote:
      "Splitzy just makes sense. No confusion, no awkward reminders, just smooth expense tracking.",
    name: "Md. Sarik",
